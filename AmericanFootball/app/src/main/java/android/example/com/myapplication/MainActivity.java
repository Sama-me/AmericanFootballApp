...
public class MainActivity extends AppCompatActivity {
    ...
    Button touchdownTeamA, touchdownTeamB, fieldGoalTeamA, fieldGoalTeamB, oneExtraTeamA, oneExtraTeamB,
            twoExtraTeamA, twoExtraTeamB, safetyTeamA, safetyTeamB;
    Button quarters;
    Button resetScore, resetTimer;
    Chronometer chronometer, chronometer2;
    Button pauseTimer, resumeTimer, stopTimer, overTime;
    ...
    public void display(int quarter) {
